...
DESTINATION_CER_NAME=$DOMAIN_NAME.cer
DESTINATION_CER_NAME=$DOMAIN_NAME.key


#transfer the file
scp /tmp/acme/$CERT_NAME/$DOMAIN_NAME/$DOMAIN_NAME.cer $USER@$DESTINATION_SERVER:$DESTINATION_PATH$DESTINATION_CER_NAME
scp /tmp/acme/$CERT_NAME/$DOMAIN_NAME/$DOMAIN_NAME.key $USER@$DESTINATION_SERVER:$DESTINATION_PATH$DESTINATION_KEY_NAME
